...
```{r p_corr_ct}
p_corr_ct <- ggplot(all_blocks, aes(x=NARA, y=Total_Time)) + 
...
```{r echo=TRUE}
corr_ct <- cor.test(all_blocks$Total_Time, all_blocks$NARA)
corr_ct
```

```{r p_corr_ctnav}
p_corr_ctnav <- ggplot(all_blocks, aes(x=NARA, y=Navigation_Time)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
...
```
```{r echo=TRUE}
corr_ctnav <- cor.test(all_blocks$Navigation_Time, all_blocks$NARA)
corr_ctnav
```

```{r p_corr_ctori}
p_corr_ctori <- ggplot(all_blocks, aes(x=NARA, y=Orientation_Time)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
...
```{r echo=TRUE}
corr_ctori <- cor.test(all_blocks$Orientation_Time, all_blocks$NARA)
corr_ctori
```

```{r p_corr_dt}
p_corr_dt <- ggplot(all_blocks, aes(x=NARA, y=Distance)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
...
```{r echo=TRUE}
corr_dt <- cor.test(all_blocks$Distance, all_blocks$NARA)
corr_dt
```

```{r p_corr_dwell}
p_corr_dwell <- ggplot(all_blocks, aes(x=NARA, y=Mean_Dwell)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
...
```{r echo=TRUE}
corr_dwell <- cor.test(all_blocks$Mean_Dwell, all_blocks$NARA)
corr_dwell
```

```{r p_corr_speed}
p_corr_speed <- ggplot(all_blocks, aes(x=NARA, y=Speed)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
...
```{r echo=TRUE}
corr_speed <- cor.test(all_blocks$Speed, all_blocks$NARA)
corr_speed
```

```{r p_corr_varx}
p_corr_varx <- ggplot(all_blocks, aes(x=NARA, y=Var_X)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_varx
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig6_varx.svg",
       height = 4, width=5, plot=p_corr_varx)
```

```{r echo=TRUE}
corr_varx <- cor.test(all_blocks$Var_X, all_blocks$NARA)
corr_varx
```

```{r p_corr_vary}
p_corr_vary <- ggplot(all_blocks, aes(x=NARA, y=Var_Y)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_vary
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig6_vary.svg",
       height = 4, width=5, plot=p_corr_vary)
```

```{r echo=TRUE}
corr_vary <- cor.test(all_blocks$Var_Y, all_blocks$NARA)
corr_vary
```


```{r p_corr_varz}
p_corr_varz <- ggplot(all_blocks, aes(x=NARA, y=Var_Z)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_varz
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig6_varz.svg",
       height = 4, width=5, plot=p_corr_varz)
```

```{r echo=TRUE}
corr_varz <- cor.test(all_blocks$Var_Z, all_blocks$NARA)
corr_varz
```


```{r p_corr_teleport}
p_corr_teleport <- ggplot(all_blocks, aes(x=NARA, y=Teleportations)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
...
```{r echo=TRUE}
corr_teleport <- cor.test(all_blocks$Teleportations, all_blocks$NARA)
corr_teleport
```