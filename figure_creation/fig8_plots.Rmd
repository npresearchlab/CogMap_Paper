...
```{r p_corr_ct}
p_corr_ct <- ggplot(b1, aes(x=NARA, y=Total_Time)) + 
...
p_corr_ct
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8 _ct.svg",
       height = 4, width=5, plot=p_corr_ct)
```

```{r echo=TRUE}
corr_ct <- cor.test(b1$Total_Time, b1$NARA)
corr_ct
```

```{r p_corr_ctnav}
p_corr_ctnav <- ggplot(b1, aes(x=NARA, y=Navigation_Time)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_ctnav
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_ctnav.svg",
       height = 4, width=5, plot=p_corr_ctnav)
```
```{r echo=TRUE}
corr_ctnav <- cor.test(b1$Navigation_Time, b1$NARA)
corr_ctnav
```

```{r p_corr_ctori}
p_corr_ctori <- ggplot(b1, aes(x=NARA, y=Orientation_Time)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_ctori
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_ctori.svg",
       height = 4, width=5, plot=p_corr_ctori)
```

```{r echo=TRUE}
corr_ctori <- cor.test(b1$Orientation_Time, b1$NARA)
corr_ctori
```

```{r p_corr_dt}
p_corr_dt <- ggplot(b1, aes(x=NARA, y=Distance)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_dt
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_dt.svg",
       height = 4, width=5, plot=p_corr_dt)
```

```{r echo=TRUE}
corr_dt <- cor.test(b1$Distance, b1$NARA)
corr_dt
```

```{r p_corr_dwell}
p_corr_dwell <- ggplot(b1, aes(x=NARA, y=Mean_Dwell)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_dwell
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_dwell.svg",
       height = 4, width=5, plot=p_corr_dwell)
```

```{r echo=TRUE}
corr_dwell <- cor.test(b1$Mean_Dwell, b1$NARA)
corr_dwell
```

```{r p_corr_speed}
p_corr_speed <- ggplot(b1, aes(x=NARA, y=Speed)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_speed
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_speed.svg",
       height = 4, width=5, plot=p_corr_speed)
```

```{r echo=TRUE}
corr_speed <- cor.test(b1$Speed, b1$NARA)
corr_speed
```

```{r p_corr_varx}
p_corr_varx <- ggplot(b1, aes(x=NARA, y=Var_X)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ylab("Var X (degrees/s)")+
  xlim(0,100)+
  theme(text = element_text(size = 20),
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
        axis.line = element_line(colour = "black"))
p_corr_varx
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_varx.svg",
       height = 4, width=5, plot=p_corr_varx)
```

```{r echo=TRUE}
corr_varx <- cor.test(b1$Var_X, b1$NARA)
corr_varx
```

```{r p_corr_vary}
p_corr_vary <- ggplot(b1, aes(x=NARA, y=Var_Y)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ylab("Var Y (degrees/x)")+
  xlim(0,100)+
  theme(text = element_text(size = 20),
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
        axis.line = element_line(colour = "black"))
p_corr_vary
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_vary.svg",
       height = 4, width=5, plot=p_corr_vary)
```

```{r echo=TRUE}
corr_vary <- cor.test(b1$Var_Y, b1$NARA)
corr_vary
```


```{r p_corr_varz}
p_corr_varz <- ggplot(b1, aes(x=NARA, y=Var_Z)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ylab("Var Z (degrees/x)")+
  xlim(0,100)+
  theme(text = element_text(size = 20),
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        panel.background = element_blank(), 
        axis.line = element_line(colour = "black"))
p_corr_varz
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_varz.svg",
       height = 4, width=5, plot=p_corr_varz)
```

```{r echo=TRUE}
corr_varz <- cor.test(b1$Var_Z, b1$NARA)
corr_varz
```


```{r p_corr_teleport}
p_corr_teleport <- ggplot(b1, aes(x=NARA, y=Teleportations)) + 
  geom_point(color = "#ffa6b4")+
  geom_smooth(method=lm, color = "black", fill = "#ffa6b4")+
  ...
  theme(text = element_text(size = 20),
        ...
        axis.line = element_line(colour = "black"))
p_corr_teleport
ggsave(file="/Users/yasminebassil/Documents/Emory/3_Research/Projects/CogMap_Paper/figure_creation/plots/fig8_teleport.svg",
       height = 4, width=5, plot=p_corr_teleport)
```

```{r echo=TRUE}
corr_teleport <- cor.test(b1$Teleportations, b1$NARA)
corr_teleport
```